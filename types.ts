...
export type View = 'dashboard' | 'womens_development' | 'education' | 'health' | 'agricultural_development' | 'income' | 'local_administration' | 'security' | 'chatbot' | 'reports' | 'development_plan' | 'water' | 'local_development_index' | 'predictive_analysis' | 'data_sources' | 'social_development' | 'priorities' | 'tourism' | 'infrastructure' | 'economic_vision';
