...
const TourismIcon = () => <IconBase><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></IconBase>;
const InfrastructureIcon = () => <IconBase><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h6m-6 4h6m-6 4h6" /></IconBase>;
...
const PrioritiesIcon = () => <IconBase><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" /></IconBase>;
const EconomicVisionIcon = () => <IconBase><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" /></IconBase>;
...
const Sidebar: React.FC<SidebarProps> = ({ activeView, setActiveView, isOpen, setIsOpen }) => {
  const sectoralViews: { view: View; icon: React.ReactNode; text: string }[] = [
      ...
      { view: 'tourism', icon: <TourismIcon />, text: 'السياحة والآثار' },
      { view: 'infrastructure', icon: <InfrastructureIcon />, text: 'البنية التحتية' },
  ...
  return (
    <aside className={`fixed inset-y-0 right-0 w-72 flex-shrink-0 bg-white p-6 flex flex-col shadow-lg transform transition-transform duration-300 ease-in-out z-30 md:relative md:translate-x-0 ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}>
      ...
      <div className="flex-1 overflow-y-auto overflow-x-hidden pb-4 custom-scrollbar">
        ...
        <nav className="space-y-2">
          ...
          <NavItem 
            viewName="economic_vision"
            icon={<EconomicVisionIcon />}
            text="مواءمة المشاريع"
            activeView={activeView}
            setActiveView={setActiveView}
            setIsOpen={setIsOpen}
          />
      ...
      {/* Fixed Bottom Area */}
      <div className="flex-shrink-0 bg-white pt-4 border-t border-gray-100 z-10">
        <NavItem 
          viewName="chatbot"
