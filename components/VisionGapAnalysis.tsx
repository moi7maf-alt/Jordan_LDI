...
import { JORDAN_VISION_2033_TARGETS, NATIONAL_AVERAGES_2025 } from '../constants';
...
const VisionGapAnalysis: React.FC = () => {
    ...
    const maxParticipation = Math.max(NATIONAL_AVERAGES_2025.female_labor_force_participation, JORDAN_VISION_2033_TARGETS.female_labor_force_participation) * 1.2;

    return (
        <Card>
            <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-1">التقدم المحرز نحو رؤية 2033</h2>
            <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">مقارنة المعدلات الوطنية لعام 2025 بالأهداف المرجوة في رؤية التحديث الاقتصادي.</p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-4">
                <VisionProgressChart 
                    name="معدل البطالة"
                    currentValue={NATIONAL_AVERAGES_2025.unemployment_rate}
                ...
                <VisionProgressChart 
                    ...
                    currentValue={NATIONAL_AVERAGES_2025.female_labor_force_participation}
